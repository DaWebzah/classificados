...
<?if(count($ads)):?>
    <div class="btn-group pull-right">
        <?if(core::config('general.auto_locate')):?>
            <button
                class="btn btn-default <?=core::request('userpos') == 1 ? 'active' : NULL?>"
                id="myLocationBtn"
                type="button"
                data-toggle="modal"
        ...
        <button type="button" id="sort" data-sort="<?=core::request('sort',core::config('advertisement.sort_by'))?>" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
