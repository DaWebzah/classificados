...
<?if(Auth::instance()->logged_in()):?>
        ...
        <div class="btn-group" role="group">
            <?if ($messages_count = $messages->count_all() > 0) :?>
                <a class="btn btn-default"
                    ...
                    data-target="#"
                >
                    <i class="fa fa-bell"></i> <span class="badge ntf"><?=$messages_count?></span>
                </a>
    ...
    <?elseif ($ads = Auth::instance()->get_user()->contacts() AND count($ads) > 0) :?>
        <div class="btn-group" role="group">
            <a class="btn dropdown-toggle btn-default" data-toggle="dropdown" href="#" id="contact-notification" data-url="<?=Route::url('oc-panel', array('controller'=>'profile', 'action'=>'notifications'))?>">
                <i class="fa fa-bell"></i> <span class="badge ntf"><?=count($ads)?></span>
            </a>
